...
#no hay    |
#Salida: 2450
# La funcion regresara el numero 2450 
...
#no hay         |
#Salida:
# La funcion genera error ya que las funciones no estan definidas
...
#no hay         |
#Salida: 2022, 2021
# La funcion genera error ya que hay mas de un return
...
#no hay         |
#Salida: 12
#El print genera error ya que no esta accesible a esta funcion

# La funcion genera error por que el número se imprime fuera de la primera funcion 
...
#x         | None
#Salida: 24
# x no imprime nada por que no tiene valor de retorno.
...
#a         |560000
#Salida: 560000, 46
#el tercer "return" no se alcanza a ejecutar, porque esta fuera de las condicionales.
...
#b         |4
#Salida: 7
#el segundo return no se ejecuta porque el de arriba rompe la funcion devolviendo un valor.
...
#Similar al anterior, pero la función retorna el valor local `hotas_de_juego`.
